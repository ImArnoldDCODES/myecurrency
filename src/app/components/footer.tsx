  ...
  return (
    <main className="bg-blend-multiply relative flex-col w-full min-h-[30rem] py-10 bg-[#12305B] bg-[url('/eclipse-footer.svg')]">
      ...
      <div className="flex flex-col lg:flex-row justify-center h-[80%] text-white pr-5 pl-10 pt-8 gap-x-20 gap-y-10 lg:gap-y-0">
        ...
        <ul>
          ...
          <div className="mt-8">
            {contactLi.map(({ title, link }, index) => (
              <li className="text-[#ABABAB] even:text-[#fff] even:font-semibold  mt-5" key={index}>
                {title}
              </li>
            ))}
          </div>
        ...
        <div>
          <h1 className="text-[1.2rem] uppercase font-semibold">CONSUMER ADVISORY</h1>
          ...
          <p className="max-w-[28rem] mt-5 text-[1rem] text-medium leading-5 font-light">
            ...
            directed on the label. <br /> All trademarks and copyrights are property of
        ...
        <div className="flex flex-col gap-5">
          <h1 className="text-[1.2rem] uppercase font-semibold">GET IN TOUCH</h1>
          <p className="text-[#ABABAB]">Feel free to get in touch with us <br /> via email</p>
          <h5 className="text-[1.7rem] font-semibold">hello@sleepstiq.com</h5>
          ...
          <p className="text-[#ABABAB] mt-5">© 2020@sleepstiq. All Rights Reserved.</p>
        </div>
      </div>
    </main>
  );
